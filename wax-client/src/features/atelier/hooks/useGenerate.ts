...
import type { RefineRequest } from '@/features/atelier/api/atelierApi';
...
export const useRefineFromPreview = () => {
  return useMutation({
    mutationFn: (req: RefineRequest) => atelierApi.refineFromPreview(req),
  });
};
